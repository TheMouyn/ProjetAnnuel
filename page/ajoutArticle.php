...
<div class="contenu">
    ...
    <tr>
        ...
        <td>
        <input class="form-item" type="text" name="titre_article" placeholder="Exemple: Le choléra." required>
        </td>
        </tr>
        ...
        <td>
        <input class="form-item" type="text" name="auteur_article" placeholder="Exemple: Institut Pasteur" required>
        </td>
        </tr>
        ...
        <td>
        <input class="form-item" type="text" name="LienSource_article" placeholder="Exemple: https://www.pasteur.fr/fr/centre-medical/fiches-maladies/cholera" required>
         </td>
        </tr>
        ...
        <td>
        <input style="display: block; width: 50%;" name="datePublication_article" type="date" id="datePublication_article" required>
        </td>
        </tr>
        ...
        <td>
        <input class="form-item" type="integer" name="id_bacterie" placeholder="Exemple: 21" required>
        </td>
        </tr>
</table>
       
        <button style="display: flex; width: 80%; justify-content: center; align-items: center; margin: 5px;" type="submit"> 
        <img style="height: 20px" src="../style/img/add.jpg" alt= ""> Ajouter l'article </button>
